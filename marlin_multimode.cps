...
properties = {
  ...
  // Static TMC setup (manual presets)
  enableTMCSetup: false,
  tmcSetupCode: "",

  // Dynamic TMC feature (advanced)
...
propertyDefinitions = {
  ...
  // Dynamic TMC property definitions
  enableTmcDynamic: {
...
function onOpen() {
  ...
  writeln("; Vendor: rflulling | Version: 1.6.0 | Credits: GitHub Copilot GPT-4.1");
...
function onLinear(x, y, z, feed) {
  ...
  // Dynamic TMC decision: decide currents based on feed thresholds
  if (properties.enableTmcDynamic && feed !== undefined) {
    ...
    // Emit if needed before the move
