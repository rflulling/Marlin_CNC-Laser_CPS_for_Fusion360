...
vendor = "rflulling";
longDescription = "Fusion360 post for Marlin with dynamic, segment-aware speed/accel/jerk. Full config, header, startup/shutdown, battery monitoring, real G-code.";
extension = "gcode";
